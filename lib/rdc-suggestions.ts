...
const SYSTEM_SUGGESTIONS: Record<string, RdcSuggestion> = {
  ...
  Anticipo: {
    ...
    titlePrefix: '[Paso Prod][ANTICIPO]',
  },
  'Abono Ya': {
    cell: 'Adquirencia',
    changeType: 'Software',
    ...
    requiresDba: true,
    selectedApprovalRoles: ['Dueño Cambio', 'QA', 'DBA', 'Deployment'],
    titlePrefix: '[Paso Prod][ABONO YA]',
  },
  Bridge: {
    cell: 'Adquirencia',
    changeType: 'Software',
  ...
  API: {
    ...
    impactedBusiness: 'Verticales',
    environment: 'Producción',
    affectedServices: 'APIs de integración, endpoints REST',
